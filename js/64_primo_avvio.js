...
/* ═══ IL MARCHIO SENZA LE STRIATURE (riscontro del founder, 25/08) ═
   Le lettere di `marchio-esteso.png` portavano striature verticali —
   artefatti di generazione. La prima idea era rifare la scritta come
   TESTO, ma `t_identita` l'ha bocciata, e aveva ragione lui: quella
   strada era già stata percorsa e tolta, perché le lettere del
   marchio sono SUE, non di un font. La correzione giusta sta
   nell'ASSET: i pixel delle lettere sono stati appiattiti ai due
   colori del marchio (corallo e verde, campionati dalle lettere
   stesse), conservando le forme e i bordi morbidi. Le striature
   erano variazioni di luminosità: a colore piatto, non esistono più.
   L'immagine è anche più PICCOLA a schermo (CSS): il logo a mezza
   pagina costringeva a scorrere per trovare «Comincia».
...
window.salutoHTML=()=>`<div class="primo saluto">
  <div class="saluto-marchio">
    <img src="assets/marchio-esteso.png" alt="Nuvia" onerror="this.style.display='none'">
  </div>
