...
const VUOTI={
  ricette: ["cucina","Le tue ricette sono una pagina bianca. Vuoi che ti prepari la settimana?","wizStart(1)","Prepara la settimana"],
  oggi:    ["cucina","Oggi è una pagina bianca. Vuoi che ti prepari la settimana?","show('ricette')","Chiedi le ricette"],
  spesa:   ["cerca","La lista si riempie da sola con gli ingredienti delle ricette. Appena ci sono le ricette, qui c'è la spesa.","show('ricette')","Vai alle ricette"],
