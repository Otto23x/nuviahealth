...
self.addEventListener("fetch",e=>{
  ...
  /* CHI CHIEDE ROBA FRESCA DEVE AVERLA FRESCA. Il controllo degli
     aggiornamenti dell'app chiede index.html con cache:"no-store": una
     richiesta cosi' passa comunque dal service worker, e servendola
     dalla cache il controllo non vedrebbe MAI una versione nuova —
     l'app resterebbe ferma per sempre credendo di essere aggiornata.
     Qui non si risponde: se ne occupa il browser, come senza di noi. */
